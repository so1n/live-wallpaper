...
from live_wallpaper.config import config_filename
...
class Service(object):
    ...
    def status(self, job: Optional[CronItem] = None) -> Tuple[str, bool]:
        ...
        if job:
            ...
            return_str += "The service has stopped"
        return return_str, bool(job)
    ...
    def _status(self) -> str:
        ...
        return_str += f"learn more run info from log path: {config_filename}\n"
        return return_str
